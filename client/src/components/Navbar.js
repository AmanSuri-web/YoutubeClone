...
console.log(state)
  const RenderMenu = () => {
    if(myCookie){
      return(
        ...
        <li className="nav-item ">
        <NavLink activeClassName="menu_active" className="nav-link" to="/video-upload">Upload</NavLink>
      </li>
      <li className="nav-item ">
  ...
  <NavLink className="navbar-brand " to="/about" style={{marginLeft:'10px'}}>AmanVideo</NavLink>
